...
app.post('/update-note', is_logged_handler, note_controller.post_note_up);
app.get('/list/:id', is_logged_handler, note_controller.get_list);
...
const mongoose_url = 'mongodb+srv://db_user:97xmBJReflmnUCMc@cluster0-wfn1d.mongodb.net/test?retryWrites=true&w=majority';
